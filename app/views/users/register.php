  ...
  <div class="row">
    <div class="col-md-6 mx-auto">
      <div class="card card-body bg-light mt-5">
        ...
        <p>Please fill the form below to register with us</p>
        <form class="" action="<?php echo URLROOT; ?>/users/register" method="post">
          <div class="form-group">
          	<label for="name">Name:<sup> *</sup></label>
          	<input type="text" name="name" class="form-control form-control-lg 
          	<?php echo (!empty($data['name_err']) ? 'is_invalid' : ''); ?>" value= "<?php echo $data['name'];?>">
          	<span class="invalid-feedback"><?php echo $data['name_err'];?></span>
          </div>

					<div class="form-group">
          	<label for="name">Choose a username:<sup> *</sup></label>
          	<input type="text" name="username" class="form-control form-control-lg 
          	<?php echo (!empty($data['username_err']) ? 'is_invalid' : ''); ?>" value= "<?php echo $data['username'];?>">
          ...
          <div class="form-group">
          	...
          	<?php echo (!empty($data['confirm_password_err']) ? 'is_invalid' : ''); ?>" value= "<?php echo $data['confirm_password'];?>">
